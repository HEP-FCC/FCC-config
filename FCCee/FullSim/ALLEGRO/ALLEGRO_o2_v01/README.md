...
cd FCC-config/FCCee/FullSim/ALLEGRO/ALLEGRO_o2_v01/
```
...
dirac-dms-add-file LFN:/fcc/prod/software/fccconfig/fccconfig-ALLEGRO_o2_v01-devel.tgz fccconfig-ALLEGRO_o2_v01-devel.tgz CERN-DST-EOS
```
