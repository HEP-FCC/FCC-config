...
muon_digitizer.ResolutionU = [
    0.4
]  # in mm, one value for all layers, or different values on the # of layers
muon_digitizer.ResolutionV = [
    0.4
]  # in mm, one value for all layers, or different values on the # of layers
...
plotTrackDCHHitDistances = PlotTrackHitDistances(
...
dNdxFromTracks = TrackdNdxDelphesBased(
    "dNdxFromTracks",
...
sipmEdep = SimulateSiPMwithEdep(
    ...
    gateLength=80.0,  # ns
    SNR=14.0,  # gain(10um)/gain(15um) = 0.5
)
...
rndmEngine = RndmEngine(
    "RndmGenSvc.Engine", SetSingleton=True, Seeds=[1234567]  # default seed is 1234567
)
...
if runTrkValidation:
    ...
    trackValidation = TrackingValidation(
        ...
        HitSimLinks=[
            ...
            "SiWrBSimDigiLinks",
            "SiWrDSimDigiLinks",
            "DCHDigisSimAssociationCollection",
        ],
