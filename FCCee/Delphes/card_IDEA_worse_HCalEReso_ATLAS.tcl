...
module DualReadoutCalorimeter Calorimeter {
  ...
  set ECalMinSignificance 1.5
  set HCalMinSignificance 1.75
  ...
  #set SmearTowerCenter false
    ...
    (abs(eta) <= 0.88 )                     * sqrt(energy^2*0.01^2 + energy*0.5^2 + 0.05^2)+
    (abs(eta) > 0.88 && abs(eta) <= 3.0)    * sqrt(energy^2*0.01^2 + energy*0.5^2 + 0.05^2)
    }
}
