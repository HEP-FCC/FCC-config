...
Init:showOneParticleData = 25

Init:showChangedSettings = on      ! list changed settings
Init:showChangedParticleData = off ! list changed particle data
Next:numberCount = 100             ! print message every n events
Next:numberShowInfo = 20            ! print event information n times
Next:numberShowProcess = 20         ! print process record n times
Next:numberShowEvent =  20          ! print event record n times
